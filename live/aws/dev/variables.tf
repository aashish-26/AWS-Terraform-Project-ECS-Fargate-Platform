// variables.tf
// Input variables for the dev environment stack.
// These are mostly wiring parameters passed down into modules.
...
variable "account_id" {
  description = "AWS account ID used for globally-unique names (for example, state bucket)."
  type        = string
}
